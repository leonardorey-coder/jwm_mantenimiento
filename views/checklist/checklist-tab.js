...
(function extendAppState() {
    ...
    const checklistDefaults = {
        ...
        // Tareas - iniciar vacío, se cargan desde API
        tareas: [],
        tareasFiltradas: [],
        tareasFilters: {
            search: '',
...
// DEFAULT_TAREAS vacío - las tareas se cargan desde la API
// No usar datos de ejemplo/demo en producción
const DEFAULT_TAREAS = [];
// Las tareas se cargan dinámicamente desde la base de datos vía API
