...
const ChecklistAPI = {
  ...
  async getAllChecklistData(filters = {}) {
    ...
    try {
      ...
      console.error(
        '❌ [ChecklistAPI.getAllChecklistData] Stack:',
        error.stack
      );
      throw error;
    }
  ...
  async updateItemEstado(cuartoId, itemId, estado, observacion = null) {
    try {
      const response = await fetch(
        `${this.baseUrl}/cuartos/${cuartoId}/items/${itemId}`,
        {
          method: 'PUT',
          headers: this.getHeaders(),
  ...
  async updateItemsBulk(cuartoId, items) {
    try {
      const response = await fetch(
        `${this.baseUrl}/cuartos/${cuartoId}/items`,
        {
          method: 'PUT',
          headers: this.getHeaders(),
  ...
  async getResumenByCuarto(cuartoId) {
    try {
      const response = await fetch(
        `${this.baseUrl}/cuartos/${cuartoId}/resumen`,
        {
          method: 'GET',
          headers: this.getHeaders(),
        }
  ...
  async getFotosByCuarto(cuartoId) {
    try {
      const response = await fetch(
        `${this.baseUrl}/cuartos/${cuartoId}/fotos`,
        {
          method: 'GET',
          headers: this.getHeaders(),
        }
  ...
  async deleteFoto(fotoId) {
    try {
      const response = await fetch(
        `${this.baseUrl.replace('/checklist', '')}/checklist/fotos/${fotoId}`,
        {
          method: 'DELETE',
          headers: this.getHeaders(),
        }
