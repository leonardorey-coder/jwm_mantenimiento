...
function mostrarAlertaBlur(mensaje, tipo = 'info') {
    ...
    alerta.querySelector('.alerta-blur-close').addEventListener('mouseenter', function() {
        this.style.backgroundColor = color.bg;
    });
    alerta.querySelector('.alerta-blur-close').addEventListener('mouseleave', function() {
