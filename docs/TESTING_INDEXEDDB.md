...
// Cuartos ocupados
const ocupados = await window.dbManager.getByIndex('cuartos', 'estado', 'ocupado');
console.log('Cuartos ocupados:', ocupados);

// Mantenimientos pendientes
const pendientes = await window.dbManager.getByIndex('mantenimientos', 'estado', 'pendiente');
